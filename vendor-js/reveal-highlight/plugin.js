/*!
 * reveal.js 6.0.1 plugin/highlight/plugin.js, vendored from
 * https://github.com/hakimel/reveal.js/blob/6.0.1/plugin/highlight/plugin.js
 * MIT License, Copyright (C) 2011-2026 Hakim El Hattab and reveal.js contributors.
 *
 * One change: the first line imports highlight.js CORE instead of the full
 * build. The languages are registered by plato.highlight, which is also what
 * makes this ~60 KB instead of the 921 KB dist plugin. Everything else is the
 * upstream file, so the stepped line highlighting is upstream behaviour.
 */
